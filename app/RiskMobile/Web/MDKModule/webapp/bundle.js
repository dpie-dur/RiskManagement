...
/***/ "./build.definitions/RiskMobile/Rules/service1/Mitigations/Mitigations_Cancel.js":
/*!***************************************************************************************!*\
  !*** ./build.definitions/RiskMobile/Rules/service1/Mitigations/Mitigations_Cancel.js ***!
  \***************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./build.definitions/RiskMobile/Rules/service1/Mitigations/Mitigations_CreateEntity.js":
/*!*********************************************************************************************!*\
  !*** ./build.definitions/RiskMobile/Rules/service1/Mitigations/Mitigations_CreateEntity.js ***!
  \*********************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./build.definitions/RiskMobile/Rules/service1/Mitigations/Mitigations_CreateRisks.js":
/*!********************************************************************************************!*\
  !*** ./build.definitions/RiskMobile/Rules/service1/Mitigations/Mitigations_CreateRisks.js ***!
  \********************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./build.definitions/RiskMobile/Rules/service1/Mitigations/Mitigations_DeleteConfirmation.js":
/*!***************************************************************************************************!*\
  !*** ./build.definitions/RiskMobile/Rules/service1/Mitigations/Mitigations_DeleteConfirmation.js ***!
  \***************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
function DeleteConfirmation(clientAPI) {
    return clientAPI.executeAction('/RiskMobile/Actions/DeleteConfirmation.action').then((result) => {
        if (result.data) {
            return clientAPI.executeAction('/RiskMobile/Actions/service1/Mitigations/Mitigations_DeleteEntity.action').then(
...
/***/ "./build.definitions/RiskMobile/Rules/service1/Mitigations/Mitigations_UpdateEntity.js":
/*!*********************************************************************************************!*\
  !*** ./build.definitions/RiskMobile/Rules/service1/Mitigations/Mitigations_UpdateEntity.js ***!
  \*********************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./build.definitions/RiskMobile/Rules/service1/Mitigations/NavToMitigations_CreateRisks.js":
/*!*************************************************************************************************!*\
  !*** ./build.definitions/RiskMobile/Rules/service1/Mitigations/NavToMitigations_CreateRisks.js ***!
  \*************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./build.definitions/RiskMobile/Rules/service1/Mitigations/NavToMitigations_Edit.js":
/*!******************************************************************************************!*\
  !*** ./build.definitions/RiskMobile/Rules/service1/Mitigations/NavToMitigations_Edit.js ***!
  \******************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./build.definitions/RiskMobile/Rules/service1/Risks/NavToRisks_Edit.js":
/*!******************************************************************************!*\
  !*** ./build.definitions/RiskMobile/Rules/service1/Risks/NavToRisks_Edit.js ***!
  \******************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
    ...
    if (clientAPI.getODataProvider('/RiskMobile/Services/service1.service').isDraftEnabled('Risks')) {
        return clientAPI.executeAction({
            ...
            'Properties': {
                ...
                'OnSuccess': '/RiskMobile/Actions/service1/Risks/NavToRisks_Edit.action'
            }
        });
    } else {
        return clientAPI.executeAction('/RiskMobile/Actions/service1/Risks/NavToRisks_Edit.action');
    }
}

/***/ }),

/***/ "./build.definitions/RiskMobile/Rules/service1/Risks/Risks_Cancel.js":
/*!***************************************************************************!*\
  !*** ./build.definitions/RiskMobile/Rules/service1/Risks/Risks_Cancel.js ***!
  \***************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./build.definitions/RiskMobile/Rules/service1/Risks/Risks_CreateEntity.js":
/*!*********************************************************************************!*\
  !*** ./build.definitions/RiskMobile/Rules/service1/Risks/Risks_CreateEntity.js ***!
  \*********************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
function CreateEntity(clientAPI) {
    if (clientAPI.getODataProvider('/RiskMobile/Services/service1.service').isDraftEnabled('Risks')) {
        return clientAPI.executeAction({
            'Name': '/RiskMobile/Actions/service1/Risks/Risks_CreateEntity.action',
            'Properties': {
                'OnSuccess': ''
            }
        }).then((result) => {
        ...
        return clientAPI.executeAction('/RiskMobile/Actions/service1/Risks/Risks_CreateEntity.action');
    }
}

/***/ }),

/***/ "./build.definitions/RiskMobile/Rules/service1/Risks/Risks_DeleteConfirmation.js":
/*!***************************************************************************************!*\
  !*** ./build.definitions/RiskMobile/Rules/service1/Risks/Risks_DeleteConfirmation.js ***!
  \***************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
function DeleteConfirmation(clientAPI) {
    return clientAPI.executeAction('/RiskMobile/Actions/DeleteConfirmation.action').then((result) => {
        if (result.data) {
            return clientAPI.executeAction('/RiskMobile/Actions/service1/Risks/Risks_DeleteEntity.action').then(
                (success) => Promise.resolve(success),
                (failure) => Promise.reject('Delete entity failed ' + failure));
        } else {
            return Promise.reject('User Deferred');
...
/***/ "./build.definitions/RiskMobile/Rules/service1/Risks/Risks_UpdateEntity.js":
/*!*********************************************************************************!*\
  !*** ./build.definitions/RiskMobile/Rules/service1/Risks/Risks_UpdateEntity.js ***!
  \*********************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
let riskmobile_actions_service1_mitigations_mitigations_createentity_action = __webpack_require__(/*! ./RiskMobile/Actions/service1/Mitigations/Mitigations_CreateEntity.action */ "./build.definitions/RiskMobile/Actions/service1/Mitigations/Mitigations_CreateEntity.action")
let riskmobile_actions_service1_mitigations_mitigations_createrisks_action = __webpack_require__(/*! ./RiskMobile/Actions/service1/Mitigations/Mitigations_CreateRisks.action */ "./build.definitions/RiskMobile/Actions/service1/Mitigations/Mitigations_CreateRisks.action")
let riskmobile_actions_service1_mitigations_mitigations_deleteentity_action = __webpack_require__(/*! ./RiskMobile/Actions/service1/Mitigations/Mitigations_DeleteEntity.action */ "./build.definitions/RiskMobile/Actions/service1/Mitigations/Mitigations_DeleteEntity.action")
let riskmobile_actions_service1_mitigations_mitigations_detailpopover_action = __webpack_require__(/*! ./RiskMobile/Actions/service1/Mitigations/Mitigations_DetailPopover.action */ "./build.definitions/RiskMobile/Actions/service1/Mitigations/Mitigations_DetailPopover.action")
let riskmobile_actions_service1_mitigations_mitigations_updateentity_action = __webpack_require__(/*! ./RiskMobile/Actions/service1/Mitigations/Mitigations_UpdateEntity.action */ "./build.definitions/RiskMobile/Actions/service1/Mitigations/Mitigations_UpdateEntity.action")
let riskmobile_actions_service1_mitigations_navtomitigations_create_action = __webpack_require__(/*! ./RiskMobile/Actions/service1/Mitigations/NavToMitigations_Create.action */ "./build.definitions/RiskMobile/Actions/service1/Mitigations/NavToMitigations_Create.action")
let riskmobile_actions_service1_mitigations_navtomitigations_createrisks_action = __webpack_require__(/*! ./RiskMobile/Actions/service1/Mitigations/NavToMitigations_CreateRisks.action */ "./build.definitions/RiskMobile/Actions/service1/Mitigations/NavToMitigations_CreateRisks.action")
let riskmobile_actions_service1_mitigations_navtomitigations_detail_action = __webpack_require__(/*! ./RiskMobile/Actions/service1/Mitigations/NavToMitigations_Detail.action */ "./build.definitions/RiskMobile/Actions/service1/Mitigations/NavToMitigations_Detail.action")
let riskmobile_actions_service1_mitigations_navtomitigations_edit_action = __webpack_require__(/*! ./RiskMobile/Actions/service1/Mitigations/NavToMitigations_Edit.action */ "./build.definitions/RiskMobile/Actions/service1/Mitigations/NavToMitigations_Edit.action")
let riskmobile_actions_service1_mitigations_navtomitigations_list_action = __webpack_require__(/*! ./RiskMobile/Actions/service1/Mitigations/NavToMitigations_List.action */ "./build.definitions/RiskMobile/Actions/service1/Mitigations/NavToMitigations_List.action")
let riskmobile_actions_service1_risks_navtorisks_create_action = __webpack_require__(/*! ./RiskMobile/Actions/service1/Risks/NavToRisks_Create.action */ "./build.definitions/RiskMobile/Actions/service1/Risks/NavToRisks_Create.action")
let riskmobile_actions_service1_risks_navtorisks_detail_action = __webpack_require__(/*! ./RiskMobile/Actions/service1/Risks/NavToRisks_Detail.action */ "./build.definitions/RiskMobile/Actions/service1/Risks/NavToRisks_Detail.action")
let riskmobile_actions_service1_risks_navtorisks_edit_action = __webpack_require__(/*! ./RiskMobile/Actions/service1/Risks/NavToRisks_Edit.action */ "./build.definitions/RiskMobile/Actions/service1/Risks/NavToRisks_Edit.action")
let riskmobile_actions_service1_risks_navtorisks_list_action = __webpack_require__(/*! ./RiskMobile/Actions/service1/Risks/NavToRisks_List.action */ "./build.definitions/RiskMobile/Actions/service1/Risks/NavToRisks_List.action")
let riskmobile_actions_service1_risks_risks_createentity_action = __webpack_require__(/*! ./RiskMobile/Actions/service1/Risks/Risks_CreateEntity.action */ "./build.definitions/RiskMobile/Actions/service1/Risks/Risks_CreateEntity.action")
let riskmobile_actions_service1_risks_risks_deleteentity_action = __webpack_require__(/*! ./RiskMobile/Actions/service1/Risks/Risks_DeleteEntity.action */ "./build.definitions/RiskMobile/Actions/service1/Risks/Risks_DeleteEntity.action")
let riskmobile_actions_service1_risks_risks_updateentity_action = __webpack_require__(/*! ./RiskMobile/Actions/service1/Risks/Risks_UpdateEntity.action */ "./build.definitions/RiskMobile/Actions/service1/Risks/Risks_UpdateEntity.action")
let riskmobile_actions_service1_service_initializeonline_action = __webpack_require__(/*! ./RiskMobile/Actions/service1/Service/InitializeOnline.action */ "./build.definitions/RiskMobile/Actions/service1/Service/InitializeOnline.action")
let riskmobile_actions_service1_service_initializeonlinefailuremessage_action = __webpack_require__(/*! ./RiskMobile/Actions/service1/Service/InitializeOnlineFailureMessage.action */ "./build.definitions/RiskMobile/Actions/service1/Service/InitializeOnlineFailureMessage.action")
...
let riskmobile_pages_service1_mitigations_mitigations_create_page = __webpack_require__(/*! ./RiskMobile/Pages/service1_Mitigations/Mitigations_Create.page */ "./build.definitions/RiskMobile/Pages/service1_Mitigations/Mitigations_Create.page")
let riskmobile_pages_service1_mitigations_mitigations_createrisks_page = __webpack_require__(/*! ./RiskMobile/Pages/service1_Mitigations/Mitigations_CreateRisks.page */ "./build.definitions/RiskMobile/Pages/service1_Mitigations/Mitigations_CreateRisks.page")
let riskmobile_pages_service1_mitigations_mitigations_detail_page = __webpack_require__(/*! ./RiskMobile/Pages/service1_Mitigations/Mitigations_Detail.page */ "./build.definitions/RiskMobile/Pages/service1_Mitigations/Mitigations_Detail.page")
let riskmobile_pages_service1_mitigations_mitigations_edit_page = __webpack_require__(/*! ./RiskMobile/Pages/service1_Mitigations/Mitigations_Edit.page */ "./build.definitions/RiskMobile/Pages/service1_Mitigations/Mitigations_Edit.page")
let riskmobile_pages_service1_mitigations_mitigations_list_page = __webpack_require__(/*! ./RiskMobile/Pages/service1_Mitigations/Mitigations_List.page */ "./build.definitions/RiskMobile/Pages/service1_Mitigations/Mitigations_List.page")
let riskmobile_pages_service1_risks_risks_create_page = __webpack_require__(/*! ./RiskMobile/Pages/service1_Risks/Risks_Create.page */ "./build.definitions/RiskMobile/Pages/service1_Risks/Risks_Create.page")
let riskmobile_pages_service1_risks_risks_detail_page = __webpack_require__(/*! ./RiskMobile/Pages/service1_Risks/Risks_Detail.page */ "./build.definitions/RiskMobile/Pages/service1_Risks/Risks_Detail.page")
let riskmobile_pages_service1_risks_risks_edit_page = __webpack_require__(/*! ./RiskMobile/Pages/service1_Risks/Risks_Edit.page */ "./build.definitions/RiskMobile/Pages/service1_Risks/Risks_Edit.page")
let riskmobile_pages_service1_risks_risks_list_page = __webpack_require__(/*! ./RiskMobile/Pages/service1_Risks/Risks_List.page */ "./build.definitions/RiskMobile/Pages/service1_Risks/Risks_List.page")
...
let riskmobile_rules_service1_mitigations_mitigations_cancel_js = __webpack_require__(/*! ./RiskMobile/Rules/service1/Mitigations/Mitigations_Cancel.js */ "./build.definitions/RiskMobile/Rules/service1/Mitigations/Mitigations_Cancel.js")
let riskmobile_rules_service1_mitigations_mitigations_createentity_js = __webpack_require__(/*! ./RiskMobile/Rules/service1/Mitigations/Mitigations_CreateEntity.js */ "./build.definitions/RiskMobile/Rules/service1/Mitigations/Mitigations_CreateEntity.js")
let riskmobile_rules_service1_mitigations_mitigations_createrisks_js = __webpack_require__(/*! ./RiskMobile/Rules/service1/Mitigations/Mitigations_CreateRisks.js */ "./build.definitions/RiskMobile/Rules/service1/Mitigations/Mitigations_CreateRisks.js")
let riskmobile_rules_service1_mitigations_mitigations_deleteconfirmation_js = __webpack_require__(/*! ./RiskMobile/Rules/service1/Mitigations/Mitigations_DeleteConfirmation.js */ "./build.definitions/RiskMobile/Rules/service1/Mitigations/Mitigations_DeleteConfirmation.js")
let riskmobile_rules_service1_mitigations_mitigations_updateentity_js = __webpack_require__(/*! ./RiskMobile/Rules/service1/Mitigations/Mitigations_UpdateEntity.js */ "./build.definitions/RiskMobile/Rules/service1/Mitigations/Mitigations_UpdateEntity.js")
let riskmobile_rules_service1_mitigations_navtomitigations_createrisks_js = __webpack_require__(/*! ./RiskMobile/Rules/service1/Mitigations/NavToMitigations_CreateRisks.js */ "./build.definitions/RiskMobile/Rules/service1/Mitigations/NavToMitigations_CreateRisks.js")
let riskmobile_rules_service1_mitigations_navtomitigations_edit_js = __webpack_require__(/*! ./RiskMobile/Rules/service1/Mitigations/NavToMitigations_Edit.js */ "./build.definitions/RiskMobile/Rules/service1/Mitigations/NavToMitigations_Edit.js")
let riskmobile_rules_service1_risks_navtorisks_edit_js = __webpack_require__(/*! ./RiskMobile/Rules/service1/Risks/NavToRisks_Edit.js */ "./build.definitions/RiskMobile/Rules/service1/Risks/NavToRisks_Edit.js")
let riskmobile_rules_service1_risks_risks_cancel_js = __webpack_require__(/*! ./RiskMobile/Rules/service1/Risks/Risks_Cancel.js */ "./build.definitions/RiskMobile/Rules/service1/Risks/Risks_Cancel.js")
let riskmobile_rules_service1_risks_risks_createentity_js = __webpack_require__(/*! ./RiskMobile/Rules/service1/Risks/Risks_CreateEntity.js */ "./build.definitions/RiskMobile/Rules/service1/Risks/Risks_CreateEntity.js")
let riskmobile_rules_service1_risks_risks_deleteconfirmation_js = __webpack_require__(/*! ./RiskMobile/Rules/service1/Risks/Risks_DeleteConfirmation.js */ "./build.definitions/RiskMobile/Rules/service1/Risks/Risks_DeleteConfirmation.js")
let riskmobile_rules_service1_risks_risks_updateentity_js = __webpack_require__(/*! ./RiskMobile/Rules/service1/Risks/Risks_UpdateEntity.js */ "./build.definitions/RiskMobile/Rules/service1/Risks/Risks_UpdateEntity.js")
...
let riskmobile_services_service1_service = __webpack_require__(/*! ./RiskMobile/Services/service1.service */ "./build.definitions/RiskMobile/Services/service1.service")
...
module.exports = {
	...
	riskmobile_actions_service1_mitigations_mitigations_createentity_action : riskmobile_actions_service1_mitigations_mitigations_createentity_action,
	riskmobile_actions_service1_mitigations_mitigations_createrisks_action : riskmobile_actions_service1_mitigations_mitigations_createrisks_action,
	riskmobile_actions_service1_mitigations_mitigations_deleteentity_action : riskmobile_actions_service1_mitigations_mitigations_deleteentity_action,
	riskmobile_actions_service1_mitigations_mitigations_detailpopover_action : riskmobile_actions_service1_mitigations_mitigations_detailpopover_action,
	riskmobile_actions_service1_mitigations_mitigations_updateentity_action : riskmobile_actions_service1_mitigations_mitigations_updateentity_action,
	riskmobile_actions_service1_mitigations_navtomitigations_create_action : riskmobile_actions_service1_mitigations_navtomitigations_create_action,
	riskmobile_actions_service1_mitigations_navtomitigations_createrisks_action : riskmobile_actions_service1_mitigations_navtomitigations_createrisks_action,
	riskmobile_actions_service1_mitigations_navtomitigations_detail_action : riskmobile_actions_service1_mitigations_navtomitigations_detail_action,
	riskmobile_actions_service1_mitigations_navtomitigations_edit_action : riskmobile_actions_service1_mitigations_navtomitigations_edit_action,
	riskmobile_actions_service1_mitigations_navtomitigations_list_action : riskmobile_actions_service1_mitigations_navtomitigations_list_action,
	riskmobile_actions_service1_risks_navtorisks_create_action : riskmobile_actions_service1_risks_navtorisks_create_action,
	riskmobile_actions_service1_risks_navtorisks_detail_action : riskmobile_actions_service1_risks_navtorisks_detail_action,
	riskmobile_actions_service1_risks_navtorisks_edit_action : riskmobile_actions_service1_risks_navtorisks_edit_action,
	riskmobile_actions_service1_risks_navtorisks_list_action : riskmobile_actions_service1_risks_navtorisks_list_action,
	riskmobile_actions_service1_risks_risks_createentity_action : riskmobile_actions_service1_risks_risks_createentity_action,
	riskmobile_actions_service1_risks_risks_deleteentity_action : riskmobile_actions_service1_risks_risks_deleteentity_action,
	riskmobile_actions_service1_risks_risks_updateentity_action : riskmobile_actions_service1_risks_risks_updateentity_action,
	riskmobile_actions_service1_service_initializeonline_action : riskmobile_actions_service1_service_initializeonline_action,
	riskmobile_actions_service1_service_initializeonlinefailuremessage_action : riskmobile_actions_service1_service_initializeonlinefailuremessage_action,
	...
	riskmobile_pages_service1_mitigations_mitigations_create_page : riskmobile_pages_service1_mitigations_mitigations_create_page,
	riskmobile_pages_service1_mitigations_mitigations_createrisks_page : riskmobile_pages_service1_mitigations_mitigations_createrisks_page,
	riskmobile_pages_service1_mitigations_mitigations_detail_page : riskmobile_pages_service1_mitigations_mitigations_detail_page,
	riskmobile_pages_service1_mitigations_mitigations_edit_page : riskmobile_pages_service1_mitigations_mitigations_edit_page,
	riskmobile_pages_service1_mitigations_mitigations_list_page : riskmobile_pages_service1_mitigations_mitigations_list_page,
	riskmobile_pages_service1_risks_risks_create_page : riskmobile_pages_service1_risks_risks_create_page,
	riskmobile_pages_service1_risks_risks_detail_page : riskmobile_pages_service1_risks_risks_detail_page,
	riskmobile_pages_service1_risks_risks_edit_page : riskmobile_pages_service1_risks_risks_edit_page,
	riskmobile_pages_service1_risks_risks_list_page : riskmobile_pages_service1_risks_risks_list_page,
	...
	riskmobile_rules_service1_mitigations_mitigations_cancel_js : riskmobile_rules_service1_mitigations_mitigations_cancel_js,
	riskmobile_rules_service1_mitigations_mitigations_createentity_js : riskmobile_rules_service1_mitigations_mitigations_createentity_js,
	riskmobile_rules_service1_mitigations_mitigations_createrisks_js : riskmobile_rules_service1_mitigations_mitigations_createrisks_js,
	riskmobile_rules_service1_mitigations_mitigations_deleteconfirmation_js : riskmobile_rules_service1_mitigations_mitigations_deleteconfirmation_js,
	riskmobile_rules_service1_mitigations_mitigations_updateentity_js : riskmobile_rules_service1_mitigations_mitigations_updateentity_js,
	riskmobile_rules_service1_mitigations_navtomitigations_createrisks_js : riskmobile_rules_service1_mitigations_navtomitigations_createrisks_js,
	riskmobile_rules_service1_mitigations_navtomitigations_edit_js : riskmobile_rules_service1_mitigations_navtomitigations_edit_js,
	riskmobile_rules_service1_risks_navtorisks_edit_js : riskmobile_rules_service1_risks_navtorisks_edit_js,
	riskmobile_rules_service1_risks_risks_cancel_js : riskmobile_rules_service1_risks_risks_cancel_js,
	riskmobile_rules_service1_risks_risks_createentity_js : riskmobile_rules_service1_risks_risks_createentity_js,
	riskmobile_rules_service1_risks_risks_deleteconfirmation_js : riskmobile_rules_service1_risks_risks_deleteconfirmation_js,
	riskmobile_rules_service1_risks_risks_updateentity_js : riskmobile_rules_service1_risks_risks_updateentity_js,
	riskmobile_rules_service_initialize_js : riskmobile_rules_service_initialize_js,
	riskmobile_services_service1_service : riskmobile_services_service1_service,
...
module.exports = {"_Name":"RiskMobile","Version":"/RiskMobile/Globals/Application/AppDefinition_Version.global","MainPage":"/RiskMobile/Pages/Main.page","OnLaunch":"/RiskMobile/Rules/Service/Initialize.js","OnWillUpdate":"/RiskMobile/Rules/Application/OnWillUpdate.js","OnDidUpdate":"/RiskMobile/Rules/Service/Initialize.js","Styles":"/RiskMobile/Styles/Styles.less","Localization":"/RiskMobile/i18n/i18n.properties","_SchemaVersion":"24.4","StyleSheets":{"Styles":{"css":"/RiskMobile/Styles/Styles.css","ios":"/RiskMobile/Styles/Styles.nss","android":"/RiskMobile/Styles/Styles.json"}}}
...
module.exports = {"_Type":"Action.Type.ODataService.DraftEnabled.Discard","Target":{"Service":"/RiskMobile/Services/service1.service","EntitySet":"Mitigations","ReadLink":"{@odata.readLink}"},"ShowActivityIndicator":true,"ActionResult":{"_Name":"update"},"OnSuccess":{"Name":"/RiskMobile/Actions/UpdateEntitySuccessMessage.action","Properties":{"Message":"Draft Discarded"}},"OnFailure":"/RiskMobile/Actions/UpdateEntityFailureMessage.action"}
...
module.exports = {"_Type":"Action.Type.ODataService.DraftEnabled.Edit","Target":{"Service":"/RiskMobile/Services/service1.service","EntitySet":"Mitigations","ReadLink":"{@odata.readLink}"},"ShowActivityIndicator":true,"ActionResult":{"_Name":"update"},"OnSuccess":{"Name":"/RiskMobile/Actions/UpdateEntitySuccessMessage.action","Properties":{"Message":"Draft Edit"}},"OnFailure":"/RiskMobile/Actions/UpdateEntityFailureMessage.action"}
...
module.exports = {"_Type":"Action.Type.ODataService.DraftEnabled.Save","Target":{"Service":"/RiskMobile/Services/service1.service","EntitySet":"Mitigations","ReadLink":"{@odata.readLink}"},"ShowActivityIndicator":true,"ActionResult":{"_Name":"update"},"OnSuccess":{"Name":"/RiskMobile/Actions/UpdateEntitySuccessMessage.action","Properties":{"Message":"Draft Saved"}},"OnFailure":"/RiskMobile/Actions/UpdateEntityFailureMessage.action"}
...
/***/ "./build.definitions/RiskMobile/Actions/service1/Mitigations/Mitigations_CreateEntity.action":
/*!***************************************************************************************************!*\
  !*** ./build.definitions/RiskMobile/Actions/service1/Mitigations/Mitigations_CreateEntity.action ***!
  \***************************************************************************************************/
/***/ ((module) => {

module.exports = {"CreateLinks":[],"OnFailure":"/RiskMobile/Actions/CreateEntityFailureMessage.action","OnSuccess":"/RiskMobile/Actions/CreateEntitySuccessMessage.action","Properties":{"Description":"#Control:Description/#Value","Owner":"#Control:Owner/#Value","Timeline":"#Control:Timeline/#Value"},"Target":{"EntitySet":"Mitigations","Service":"/RiskMobile/Services/service1.service"},"ActionResult":{"_Name":"create"},"_Type":"Action.Type.ODataService.CreateEntity"}

/***/ }),

/***/ "./build.definitions/RiskMobile/Actions/service1/Mitigations/Mitigations_CreateRisks.action":
/*!**************************************************************************************************!*\
  !*** ./build.definitions/RiskMobile/Actions/service1/Mitigations/Mitigations_CreateRisks.action ***!
  \**************************************************************************************************/
/***/ ((module) => {
...
/***/ "./build.definitions/RiskMobile/Actions/service1/Mitigations/Mitigations_DeleteEntity.action":
/*!***************************************************************************************************!*\
  !*** ./build.definitions/RiskMobile/Actions/service1/Mitigations/Mitigations_DeleteEntity.action ***!
  \***************************************************************************************************/
/***/ ((module) => {

module.exports = {"Target":{"EntitySet":"Mitigations","Service":"/RiskMobile/Services/service1.service","ReadLink":"{@odata.readLink}"},"OnSuccess":"/RiskMobile/Actions/DeleteEntitySuccessMessage.action","OnFailure":"/RiskMobile/Actions/DeleteEntityFailureMessage.action","ActionResult":{"_Name":"delete"},"_Type":"Action.Type.ODataService.DeleteEntity"}

/***/ }),

/***/ "./build.definitions/RiskMobile/Actions/service1/Mitigations/Mitigations_DetailPopover.action":
/*!****************************************************************************************************!*\
  !*** ./build.definitions/RiskMobile/Actions/service1/Mitigations/Mitigations_DetailPopover.action ***!
  \****************************************************************************************************/
/***/ ((module) => {

module.exports = {"PopoverItems":[{"Title":"Add Risks","OnPress":"/RiskMobile/Rules/service1/Mitigations/NavToMitigations_CreateRisks.js"},{"Title":"Delete","OnPress":"/RiskMobile/Rules/service1/Mitigations/Mitigations_DeleteConfirmation.js"}],"_Type":"Action.Type.PopoverMenu"}

/***/ }),

/***/ "./build.definitions/RiskMobile/Actions/service1/Mitigations/Mitigations_UpdateEntity.action":
/*!***************************************************************************************************!*\
  !*** ./build.definitions/RiskMobile/Actions/service1/Mitigations/Mitigations_UpdateEntity.action ***!
  \***************************************************************************************************/
/***/ ((module) => {

module.exports = {"_Type":"Action.Type.ODataService.UpdateEntity","Target":{"EntitySet":"Mitigations","Service":"/RiskMobile/Services/service1.service","ReadLink":"{@odata.readLink}"},"Properties":{"Description":"#Control:Description/#Value","Owner":"#Control:Owner/#Value","Timeline":"#Control:Timeline/#Value"},"UpdateLinks":[],"ActionResult":{"_Name":"update"},"OnSuccess":"/RiskMobile/Actions/UpdateEntitySuccessMessage.action","OnFailure":"/RiskMobile/Actions/UpdateEntityFailureMessage.action"}

/***/ }),

/***/ "./build.definitions/RiskMobile/Actions/service1/Mitigations/NavToMitigations_Create.action":
/*!**************************************************************************************************!*\
  !*** ./build.definitions/RiskMobile/Actions/service1/Mitigations/NavToMitigations_Create.action ***!
  \**************************************************************************************************/
/***/ ((module) => {

module.exports = {"ModalPageFullscreen":false,"ModalPage":true,"PageToOpen":"/RiskMobile/Pages/service1_Mitigations/Mitigations_Create.page","_Type":"Action.Type.Navigation"}

/***/ }),

/***/ "./build.definitions/RiskMobile/Actions/service1/Mitigations/NavToMitigations_CreateRisks.action":
/*!*******************************************************************************************************!*\
  !*** ./build.definitions/RiskMobile/Actions/service1/Mitigations/NavToMitigations_CreateRisks.action ***!
  \*******************************************************************************************************/
/***/ ((module) => {

module.exports = {"ModalPageFullscreen":false,"ModalPage":true,"PageToOpen":"/RiskMobile/Pages/service1_Mitigations/Mitigations_CreateRisks.page","_Type":"Action.Type.Navigation"}

/***/ }),

/***/ "./build.definitions/RiskMobile/Actions/service1/Mitigations/NavToMitigations_Detail.action":
/*!**************************************************************************************************!*\
  !*** ./build.definitions/RiskMobile/Actions/service1/Mitigations/NavToMitigations_Detail.action ***!
  \**************************************************************************************************/
/***/ ((module) => {

module.exports = {"_Type":"Action.Type.Navigation","PageToOpen":"/RiskMobile/Pages/service1_Mitigations/Mitigations_Detail.page"}

/***/ }),

/***/ "./build.definitions/RiskMobile/Actions/service1/Mitigations/NavToMitigations_Edit.action":
/*!************************************************************************************************!*\
  !*** ./build.definitions/RiskMobile/Actions/service1/Mitigations/NavToMitigations_Edit.action ***!
  \************************************************************************************************/
/***/ ((module) => {

module.exports = {"ModalPageFullscreen":false,"ModalPage":true,"PageToOpen":"/RiskMobile/Pages/service1_Mitigations/Mitigations_Edit.page","_Type":"Action.Type.Navigation"}

/***/ }),

/***/ "./build.definitions/RiskMobile/Actions/service1/Mitigations/NavToMitigations_List.action":
/*!************************************************************************************************!*\
  !*** ./build.definitions/RiskMobile/Actions/service1/Mitigations/NavToMitigations_List.action ***!
  \************************************************************************************************/
/***/ ((module) => {

module.exports = {"_Type":"Action.Type.Navigation","PageToOpen":"/RiskMobile/Pages/service1_Mitigations/Mitigations_List.page"}

/***/ }),

/***/ "./build.definitions/RiskMobile/Actions/service1/Risks/NavToRisks_Create.action":
/*!**************************************************************************************!*\
  !*** ./build.definitions/RiskMobile/Actions/service1/Risks/NavToRisks_Create.action ***!
  \**************************************************************************************/
/***/ ((module) => {

module.exports = {"ModalPageFullscreen":false,"ModalPage":true,"PageToOpen":"/RiskMobile/Pages/service1_Risks/Risks_Create.page","_Type":"Action.Type.Navigation"}

/***/ }),

/***/ "./build.definitions/RiskMobile/Actions/service1/Risks/NavToRisks_Detail.action":
/*!**************************************************************************************!*\
  !*** ./build.definitions/RiskMobile/Actions/service1/Risks/NavToRisks_Detail.action ***!
  \**************************************************************************************/
/***/ ((module) => {

module.exports = {"_Type":"Action.Type.Navigation","PageToOpen":"/RiskMobile/Pages/service1_Risks/Risks_Detail.page"}

/***/ }),

/***/ "./build.definitions/RiskMobile/Actions/service1/Risks/NavToRisks_Edit.action":
/*!************************************************************************************!*\
  !*** ./build.definitions/RiskMobile/Actions/service1/Risks/NavToRisks_Edit.action ***!
  \************************************************************************************/
/***/ ((module) => {

module.exports = {"ModalPageFullscreen":false,"ModalPage":true,"PageToOpen":"/RiskMobile/Pages/service1_Risks/Risks_Edit.page","_Type":"Action.Type.Navigation"}

/***/ }),

/***/ "./build.definitions/RiskMobile/Actions/service1/Risks/NavToRisks_List.action":
/*!************************************************************************************!*\
  !*** ./build.definitions/RiskMobile/Actions/service1/Risks/NavToRisks_List.action ***!
  \************************************************************************************/
/***/ ((module) => {

module.exports = {"_Type":"Action.Type.Navigation","PageToOpen":"/RiskMobile/Pages/service1_Risks/Risks_List.page"}

/***/ }),

/***/ "./build.definitions/RiskMobile/Actions/service1/Risks/Risks_CreateEntity.action":
/*!***************************************************************************************!*\
  !*** ./build.definitions/RiskMobile/Actions/service1/Risks/Risks_CreateEntity.action ***!
  \***************************************************************************************/
/***/ ((module) => {
...
/***/ "./build.definitions/RiskMobile/Actions/service1/Risks/Risks_DeleteEntity.action":
/*!***************************************************************************************!*\
  !*** ./build.definitions/RiskMobile/Actions/service1/Risks/Risks_DeleteEntity.action ***!
  \***************************************************************************************/
/***/ ((module) => {
...
/***/ "./build.definitions/RiskMobile/Actions/service1/Risks/Risks_UpdateEntity.action":
/*!***************************************************************************************!*\
  !*** ./build.definitions/RiskMobile/Actions/service1/Risks/Risks_UpdateEntity.action ***!
  \***************************************************************************************/
/***/ ((module) => {

module.exports = {"_Type":"Action.Type.ODataService.UpdateEntity","Target":{"EntitySet":"Risks","Service":"/RiskMobile/Services/service1.service","ReadLink":"{@odata.readLink}"},"Properties":{"Title":"#Control:Title/#Value","Prio":"#Control:Prio/#Value","Descr":"#Control:Descr/#Value","Impact":"#Control:Impact/#Value","Criticality":"#Control:Criticality/#Value","supplier_BusinessPartner":"#Control:supplier_BusinessPartner/#SelectedValue"},"UpdateLinks":[],"ActionResult":{"_Name":"update"},"OnSuccess":"/RiskMobile/Actions/UpdateEntitySuccessMessage.action","OnFailure":"/RiskMobile/Actions/UpdateEntityFailureMessage.action"}

/***/ }),

/***/ "./build.definitions/RiskMobile/Actions/service1/Service/InitializeOnline.action":
/*!***************************************************************************************!*\
  !*** ./build.definitions/RiskMobile/Actions/service1/Service/InitializeOnline.action ***!
  \***************************************************************************************/
/***/ ((module) => {

module.exports = {"Service":"/RiskMobile/Services/service1.service","_Type":"Action.Type.ODataService.Initialize","ShowActivityIndicator":true,"OnFailure":"/RiskMobile/Actions/service1/Service/InitializeOnlineFailureMessage.action","ActionResult":{"_Name":"init"}}

/***/ }),

/***/ "./build.definitions/RiskMobile/Actions/service1/Service/InitializeOnlineFailureMessage.action":
/*!*****************************************************************************************************!*\
  !*** ./build.definitions/RiskMobile/Actions/service1/Service/InitializeOnlineFailureMessage.action ***!
  \*****************************************************************************************************/
/***/ ((module) => {
...
/***/ "./build.definitions/RiskMobile/Services/service1.service":
/*!****************************************************************!*\
  !*** ./build.definitions/RiskMobile/Services/service1.service ***!
  \****************************************************************/
/***/ ((module) => {

module.exports = {"DestinationName":"../service/RiskM1Svcs/","OfflineEnabled":false,"LanguageURLParam":"","OnlineOptions":{},"OfflineOptions":{},"PathSuffix":"","SourceType":"Cloud","ServiceUrl":""}
